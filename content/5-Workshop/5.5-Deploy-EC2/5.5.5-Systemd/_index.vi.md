...
<!-- TODO: Thêm /images/5-Workshop/5.5-Deploy-EC2/systemd-active.png. Caption: *Hình 5.5.5.1. techblog.service ở trạng thái active (running).* -->
<!-- TODO: Thêm /images/5-Workshop/5.5-Deploy-EC2/curl-http-200.png. Caption: *Hình 5.5.5.2. Kiểm tra HTTP 200 local trên EC2.* -->
