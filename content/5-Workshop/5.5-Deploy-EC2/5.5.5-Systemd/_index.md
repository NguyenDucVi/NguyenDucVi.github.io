...
<!-- TODO: Add /images/5-Workshop/5.5-Deploy-EC2/systemd-active.png. Caption: *Figure 5.5.5.1. techblog.service active (running).* -->
<!-- TODO: Add /images/5-Workshop/5.5-Deploy-EC2/curl-http-200.png. Caption: *Figure 5.5.5.2. Local HTTP 200 verification on EC2.* -->
