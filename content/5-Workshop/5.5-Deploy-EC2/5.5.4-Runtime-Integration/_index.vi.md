...
Không copy file thật vào report. Nếu source code dùng environment-variable name khác, dùng đúng tên trong configuration class hiện tại và cập nhật hai bản ngôn ngữ giống nhau.
...
<!-- TODO: Thêm /images/5-Workshop/5.5-Deploy-EC2/runtime-config-redacted.png. Caption: *Hình 5.5.4.1. Runtime variable name đã che giá trị và protected file permission.* -->
