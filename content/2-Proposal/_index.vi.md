...
Bản demo TechBlog hiện có thể truy cập tại:

[http://13.212.52.148:8080/](http://13.212.52.148:8080/)

Website được phục vụ trực tiếp bởi Spring Boot trên Amazon EC2 qua HTTP port `8080`. Bản demo hiện chưa sử dụng domain hoặc HTTPS và dự kiến được duy trì đến ngày 30/07/2026. Các placeholder như `<EC2_PUBLIC_IP>` vẫn được giữ trong lệnh triển khai vì public IP có thể thay đổi sau khi EC2 bị stop/start.
...
<figure>
  <img src="/images/2-Proposal/Techblog%20Workflow%20AWS.png" alt="Workflow TechBlog đã triển khai trên AWS" style="width: 100%; height: auto;">
...
|---|---|---|
| EC2 public IP đổi sau stop/start | URL demo đã công bố không còn truy cập được | Kiểm tra IP hiện tại và cập nhật link demo công khai; chỉ giữ `<EC2_PUBLIC_IP>` trong các lệnh triển khai có thể tái sử dụng. |
