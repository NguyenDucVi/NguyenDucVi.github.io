...
The current TechBlog demo is available at:

[http://13.212.52.148:8080/](http://13.212.52.148:8080/)

The website is served directly by Spring Boot on Amazon EC2 over HTTP port `8080`. It does not currently use a domain or HTTPS and is expected to remain available until July 30, 2026. Placeholders such as `<EC2_PUBLIC_IP>` are still used in deployment commands because the public IP may change after the instance is stopped and started.
...
<figure>
  <img src="/images/2-Proposal/Techblog%20Workflow%20AWS.png" alt="Implemented TechBlog workflow on AWS" style="width: 100%; height: auto;">
...
|---|---|---|
| EC2 public IP changes after stop/start | The published demo URL becomes unavailable | Verify the current IP and update the public demo link; keep `<EC2_PUBLIC_IP>` only in reusable deployment commands. |
